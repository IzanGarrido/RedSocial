-- Insert data into the companies and games tables
...
-- Insert categories for each game
...
-- If there are still games withoout a category, assign them a generic one (Action)
UPDATE JUEGOS SET ID_CATEGORIA = (SELECT ID_CATEGORIA FROM CATEGORIAS WHERE CATEGORIA = 'Acción') 
WHERE ID_CATEGORIA IS NULL;

-- Add descriptions for the games
