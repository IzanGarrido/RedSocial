...
<header class="navbar navbar-expand-lg navbar-dark bg-primary py-2 sticky-top">
  <div class="container">
    ...
    <a class="navbar-brand d-flex align-items-center" href="#">
      <img src="./assets/App-images/Gameord-logo.webp" alt="Logo" class="me-2" height="40">
      <span class="fw-bold fs-4 d-lg-block d-none">Gameord</span>
    </a>
    
    <!-- Search -->
    <div class="position-relative mx-3 flex-grow-1">
      <i class="bi bi-search position-absolute text-muted" style="top: 8px; left: 12px;"></i>
      <input type="text" class="form-control ps-5" placeholder="">
    </div>
    ...
    <div class="collapse navbar-collapse flex-grow-0" id="navbarContent">
      ...
      <ul class="navbar-nav d-flex align-items-center">
        ...
        <li class="nav-item mx-1 mx-lg-2">
          <a class="nav-link" href="#" title="Soporte">
            <i class="bi bi-headset fs-4"></i>
          </a>
        </li>
        <li class="nav-item mx-1 mx-lg-2">
          <a class="nav-link" href="#" title="Crear">
