    ...
    <header class="navbar navbar-expand-lg navbar-dark py-2 sticky-top">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <button class="btn btn-outline-light d-lg-none ms-2" type="button" data-bs-toggle="modal"
                    data-bs-target="#mobileMenuModal" title="Menú">
              ...
              ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0" aria-labelledby="userDropdown"
                            ...
                            <li><a class="dropdown-item py-2"
                                    href="./pages/user.php?user=<?php echo urlencode($_SESSION['username']); ?>"><i
                ...
                <div class="modal-body p-0">
                    <ul class="nav nav-tabs nav-fill border-0" id="mobileMenuTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active px-4 py-3 fw-semibold" id="categories-tab"
                                data-bs-toggle="tab" data-bs-target="#categories-content" type="button" role="tab">
                                <i class="bi bi-grid-3x3-gap-fill me-2"></i>Categorías
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link px-4 py-3 fw-semibold" id="games-tab" data-bs-toggle="tab"
                                data-bs-target="#games-content" type="button" role="tab">
                            ...
                            <div class="p-3">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="mobile-games-search" class="form-control border-start-0"
                                            placeholder="Buscar juegos..." autocomplete="off">
                                    </div>
                                </div>

                                <div class="row g-2" id="mobile-games-container"
        ...
        <div class="modal-dialog modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" id="searchInput2" class="form-control search-box"
                        placeholder="Buscar juegos, categorías, usuarios..." aria-label="Buscar">
    ...
    <div class="modal fade" id="createPostModal" tabindex="-1" aria-labelledby="createPostModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="createPostForm" action="includes/create_post.php" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control d-none" type="file" id="postMedia" name="postMedia"
                                accept="image/*,video/*">
            ...
            <div class="col-lg-3 d-none d-lg-block p-0 position-fixed ">
                ...
                ?>
                  ...
                  ?>
                            ...
                            <div class="text-center mt-2">
                                <button class="btn btn-sm btn-outline-primary" id="btn-toggle-categorias">Ver más
                                    categorías</button>
                            </div>
                            <?php endif; ?>
                        </section>
                ...
                ?>
                  ...
                  ?>
                            ...
                            <div class="text-center mt-2">
                                <button class="btn btn-sm btn-outline-primary" id="btn-toggle-juegos">Ver más
                                    juegos</button>
                            </div>
                            <?php endif; ?>
                          ...
                          " class="text-decoration-none text-dark">
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    <div class="d-flex align-items-center game-info me-3">
                                        <img src="<?php echo $publicacion['GAME_IMAGE']; ?>"
                                            class="rounded-circle me-2 game-image" width="40" height="40" alt="Game">
                                        <div>
                                            <h6 class="mb-0 game-title">
                                                <a href="./pages/games.php?id=<?php echo $publicacion['IDJUEGO'] ?? ''; ?>"
                                                    class="text-decoration-none text-dark">
                                    ...
                                    <div class="d-flex align-items-center game-info">
                                        ...
                                        <div>
                                            <h6 class="mb-0 game-title">
                                                <a href="./pages/categories.php?id=<?php echo $publicacion['ID_CATEGORIA'] ?? ''; ?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center media-container">
                                    <img src="<?php echo $publicacion['URL']; ?>" class="post-media img-fluid"
                                        alt="Post image">
                                </div>
