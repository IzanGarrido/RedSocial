    ...
    <div class="container-fluid bg-light py-4 border-bottom">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h1 class="mb-2 text-primary fw-bold"><?php echo htmlspecialchars($categoryInfo['CATEGORIA']); ?>
                    </h1>
                    <p class="text-muted mb-0">
                        Explora todas las publicaciones relacionadas con
                        <?php echo htmlspecialchars($categoryInfo['CATEGORIA']); ?>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Aún no hay publicaciones en la categoría
                        <?php echo htmlspecialchars($categoryInfo['CATEGORIA']); ?>.</p>
