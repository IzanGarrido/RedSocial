                ...
                <li class="nav-item mx-2 position-static">
                    <div class="dropdown">
                        <a class="nav-link d-flex align-items-center" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                            <img src="<?php echo $currentProfileImage; ?>" alt="User" class="rounded-circle me-1" width="32" height="32">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0" aria-labelledby="userDropdown" style="min-width: 200px;">
                            <li class="px-3 py-2 border-bottom">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo $currentProfileImage; ?>" alt="User" class="rounded-circle me-2" width="40" height="40">
                                    <div>
                            ...
                            <li><a class="dropdown-item py-2" href="./user.php?user=<?php echo urlencode($currentUsername); ?>"><i class="bi bi-person me-2"></i>Mi perfil</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-auto">
                    <img src="<?php echo getCorrectUserImage($userInfo['URL_FOTO']); ?>"
                        alt="<?php echo htmlspecialchars($userInfo['USUARIO']); ?>"
                        class="rounded-circle shadow-sm"
                        style="width: 120px; height: 120px; object-fit: cover;">
                </div>
                <div class="col">
                    <div class="d-flex align-items-center mb-2">
                        <h1 class="text-primary fw-bold me-3 mb-0">@<?php echo htmlspecialchars($userInfo['USUARIO']); ?></h1>
                        <?php if (!$isOwnProfile) { ?>
                            <form method="post" class="d-inline">
                                <button type="submit" name="toggle_follow" class="btn <?php echo $siguiendo ? 'btn-secondary' : 'btn-primary'; ?>">
